...
export const TEXT_EXPR = `(() => {
  export const el = createTextNode$POSTFIX$();
$CODE$
  $PUSH_ELE$
  return el;
})()`;
...
export const PARAMETER = `...(() => {
  export const __ac = $VM_RENDERER$[__$POSTFIX$].slots;
  export const renderFn = __ac && __ac['$ARG_USE$'] ? __ac['$ARG_USE$'] : $DEFAULT$;
  export const attrs = attrs$POSTFIX$({
    $VM_PASS_INIT$
    [__$POSTFIX$]: {
      $VM_DEBUG_NAME$
      context: component[__$POSTFIX$].context,
...
$VM_PASS_SET$
  export const el = (new ParameterComponent$POSTFIX$(attrs, $VM_PASS_PARAM$))[$$$POSTFIX$].proxy;
$VM_PASS_WATCH$
$PUSH_ELE$
  return assertRenderResults$POSTFIX$(el.__render());
})()`;
